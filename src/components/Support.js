  ...
  return (
    <section name="support" className='w-full mt-24'>
      <div className='w-full h-[700px] bg-slate-900/90 absolute'>
        <img src={supportImg} className='object-cover w-full h-full mix-blend-over'/>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
        <div className='px-4 py-12'>
          ...
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque tristique dui et dapibus lobortis. Vivamus semper.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 px-4 pt-12 text-black gap-x-8 gap-y-16 sm:pt-20'>
          <div className='bg-white shadow-2xl rounded-xl'>
            <div className='p-8'>
              <h3 className='my06 text-2xl font-bold'>Support</h3>
              <p className='text-xl text-gray-600'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque tristique dui et dapibus lobortis. Vivamus semper</p>
            </div>
